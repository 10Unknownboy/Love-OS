...
const LoveWrapped: React.FC = () => {
  ...
  const relationshipStats = [
    { title: "Days Together", value: "180", subtitle: "and counting... 💕", icon: "📅", type: "counter" },
    { title: "Relationship Started", value: "27 Dec 2024", subtitle: "best decision ever", icon: "🌟", type: "date" },
    { title: "First Date", value: "25 Dec 2024", subtitle: "Christmas magic ✨", icon: "🎄", type: "date" },
    { title: "First Kiss", value: "Lane 26", subtitle: "butterflies everywhere", icon: "💋", type: "location" },
    { title: "First Hug", value: "APTC", subtitle: "home in your arms", icon: "🤗", type: "location" },
    { title: "Best Day", value: "16 June 2025", subtitle: "guess what happened... 😉", icon: "🎉", type: "date" },
    { title: "Most Used Word", value: "nahi", subtitle: "so stubborn! 😂", icon: "💬", type: "text" },
    { title: "Total Messages", value: "647,300", subtitle: "never running out of words", icon: "📱", type: "progress", max: 700000 },
    { title: "Her Words", value: "35,400", subtitle: "always has more to say 💖", icon: "👩‍💋‍👨", type: "progress", max: 40000 },
    { title: "His Words", value: "26,519", subtitle: "quality over quantity 😎", icon: "👨‍💋‍👩", type: "progress", max: 40000 },
    { title: "Reels Shared", value: "14,742", subtitle: "sharing laughs daily", icon: "🎬", type: "progress", max: 20000 },
    { title: "Love Count", value: "9,872", subtitle: "never enough I love yous", icon: "❤️", type: "progress", max: 15000 },
    { title: "I Love You Count", value: "69", subtitle: "the perfect number 😏", icon: "💘", type: "counter" },
    { title: "Busiest Day", value: "Monday", subtitle: "starting weeks with love", icon: "📆", type: "text" },
    { title: "Longest Call", value: "10 hours", subtitle: "time flies when you're happy", icon: "📞", type: "counter" },
    { title: "Total Calls", value: "461", subtitle: "hearing your voice daily", icon: "☎️", type: "progress", max: 500 },
    { title: "Emojis Sent", value: "2,796", subtitle: "expressing love in pixels", icon: "😍", type: "progress", max: 5000 },
    { title: "Top Song", value: "O' Rangrez", subtitle: "by Wajid Ali - our anthem", icon: "🎵", type: "text" }
  ];
      ...
      <div className="text-center py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            180 days of magic, laughter, and endless love 💕
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <div className="glass-effect rounded-2xl p-6 text-center">
            ...
            <div className="text-2xl font-bold text-pink-600">647K</div>
            <div className="text-sm text-gray-600">Messages</div>
          </div>
          <div className="glass-effect rounded-2xl p-6 text-center">
            <Phone className="mx-auto text-rose-500 mb-2" size={32} />
            <div className="text-2xl font-bold text-rose-600">461</div>
            <div className="text-sm text-gray-600">Calls</div>
          </div>
          <div className="glass-effect rounded-2xl p-6 text-center">
            <Heart className="mx-auto text-purple-500 mb-2" size={32} />
            <div className="text-2xl font-bold text-purple-600">9.8K</div>
        ...
        <div className="glass-effect rounded-3xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold text-pink-600 mb-4">Billo (A)</h4>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Words:</span>
                  <span className="font-bold text-pink-600">35,400</span>
                </div>
                <div className="w-full bg-pink-100 rounded-full h-3">
                  <div className="bg-pink-500 h-3 rounded-full" style={{ width: '57%' }}></div>
                </div>
              </div>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">👨</div>
              <h4 className="text-xl font-bold text-blue-600 mb-4">Billu (S)</h4>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Words:</span>
                  <span className="font-bold text-blue-600">26,519</span>
                </div>
                <div className="w-full bg-blue-100 rounded-full h-3">
                  <div className="bg-blue-500 h-3 rounded-full" style={{ width: '43%' }}></div>
                </div>
              </div>
            </div>
          </div>
